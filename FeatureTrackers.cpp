...
//printf("min_z: %f\n", min_z);
  ...
  if(model_features) {
    ...
    model_features->nostril_positions[0].x = best_fit[0][0] + new_center[0];
    model_features->nostril_positions[0].y = best_fit[0][1] + new_center[1];
    model_features->nostril_positions[1].x = best_fit[1][0] + new_center[0];
    model_features->nostril_positions[1].y = best_fit[1][1] + new_center[1];
    model_features->lip_positions[0].x = best_fit[2][0] + new_center[0];
    model_features->lip_positions[0].y = best_fit[2][1] + new_center[1];
    model_features->lip_positions[1].x = best_fit[3][0] + new_center[0];
    model_features->lip_positions[1].y = best_fit[3][1] + new_center[1];
    model_features->nose_bridge.x = best_fit[4][0] + new_center[0];
    model_features->nose_bridge.y = best_fit[4][1] + new_center[1];
    model_features->pupils[0].x = best_fit[5][0] + new_center[0];
    model_features->pupils[0].y = best_fit[5][1] + new_center[1];
    model_features->pupils[1].x = best_fit[6][0] + new_center[0];
    model_features->pupils[1].y = best_fit[6][1] + new_center[1];
    model_features->eyebrow_ends[0].x = best_fit[7][0] + new_center[0];
    model_features->eyebrow_ends[0].y = best_fit[7][1] + new_center[1];
    model_features->eyebrow_ends[1].x = best_fit[8][0] + new_center[0];
    model_features->eyebrow_ends[1].y = best_fit[8][1] + new_center[1];
  }
}